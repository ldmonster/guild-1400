...
const TutorialNodeSpec kChapter1[] = {
  ...
  {  1, "1rtn", 0, 7362, "CHAPTER_1_INTRO",    0,    nullptr,             0,    nullptr,           0,    nullptr,          -1,         142,   TutorialCallback::kNone,    TutorialCallback::kNone,                TutorialCallback::kSharedMatch, 0,    0,    11,  0,      0,    0 },
  {  1, "As1c", 1, 7364, "CHAPTER_1_A_MAIN", 7366, "CHAPTER_1_A_REMIND",  0,    nullptr,        7367, "CHAPTER_1_A_DONE", kVoiceMain, 355,   TutorialCallback::kNone,    TutorialCallback::kNone,                TutorialCallback::kSharedMatch, 22,   0,    11,  0,      0,    0 },
  {  1, "Cs1c", 2, 7368, "CHAPTER_1_C_MAIN", 7371, "CHAPTER_1_C_REMIND", 7370, "Chapter_1_C_Aux", 7372, "CHAPTER_1_C_DONE", kVoiceMain, 142,   TutorialCallback::kNone,    TutorialCallback::kNone,                TutorialCallback::kSharedMatch, 6,    8520, 9,   7,      1,    0 },
  {  1, "Ds1c", 2, 7373, "CHAPTER_1_D_MAIN", 7376, "CHAPTER_1_D_REMIND", 7375, "Chapter_1_D_Aux", 7377, "CHAPTER_1_D_DONE", kVoiceMain, 142,   TutorialCallback::kNone,    TutorialCallback::kNone,                TutorialCallback::kSharedMatch, 8,    8520, 9,   9,      3,    0 },
  {  1, "Es1c", 2, 7378, "CHAPTER_1_E_MAIN", 7381, "CHAPTER_1_E_REMIND", 7380, "Chapter_1_E_Aux", 7382, "CHAPTER_1_E_DONE", kVoiceMain, 142,   TutorialCallback::kNone,    TutorialCallback::kPickupDropTransition, TutorialCallback::kSharedMatch, 1,    8520, 9,   0,      7,    0 },
  {  1, "Fs1c", 1, 7383, "CHAPTER_1_F_MAIN",   0,    nullptr,             0,    nullptr,           0,    nullptr,          kVoiceMain, 71,    TutorialCallback::kNone,    TutorialCallback::kNone,                TutorialCallback::kSharedMatch, 3,    71,   11,  0,      7,    0 },
  {  1, "Gs1c", 1, 7385, "CHAPTER_1_G_MAIN", 7387, "CHAPTER_1_G_REMIND",  0,    nullptr,        7388, "CHAPTER_1_G_DONE", kVoiceMain, 142,   TutorialCallback::kNone,    TutorialCallback::kNone,                TutorialCallback::kSharedMatch, 12,   8520, 10,  0,      23,   0 },
...
const TutorialNodeSpec kChapter2[] = {
  {  2, "2rtn", 0, 7403, "CHAPTER_2_INTRO",    0,    nullptr,             0,    nullptr,           0,    nullptr,          -1,         142,   TutorialCallback::kNone,                  TutorialCallback::kNone,              TutorialCallback::kSharedMatch,            0,  0,    11, 0, 6199,  0 },
  {  2, "As2c", 1, 7405, "CHAPTER_2_A_MAIN", 7407, "CHAPTER_2_A_REMIND",  0,    nullptr,        7408, "CHAPTER_2_A_DONE", kVoiceMain, 142,   TutorialCallback::kNone,                  TutorialCallback::kEvent23Or24SetState, TutorialCallback::kSharedMatch,           1,  8520, 10, 0, 6199,  0 },
  {  2, "Bs2c", 1, 7409, "CHAPTER_2_B_MAIN", 7411, "CHAPTER_2_B_REMIND",  0,    nullptr,        7412, "CHAPTER_2_B_DONE", kVoiceMain, 213,   TutorialCallback::kBeginQuerySetField270, TutorialCallback::kEvent25Code270,    TutorialCallback::kMatchObjectDropTarget,  1,  8520, 11, 0, 22583, 0 },
  {  2, "Cs2c", 1, 7413, "CHAPTER_2_C_MAIN", 7415, "CHAPTER_2_C_REMIND",  0,    nullptr,        7416, "CHAPTER_2_C_DONE", kVoiceMain, 142,   TutorialCallback::kNone,                  TutorialCallback::kEvent25Code272,    TutorialCallback::kMatchPersonState15Cmd272, 1, 8520, 10, 0, 22583, 3584 },
  {  2, "Ds2c", 1, 7417, "CHAPTER_2_C1_MAIN",7419,"CHAPTER_2_C1_REMIND",  0,    nullptr,        7420, "CHAPTER_2_C1_DONE",kVoiceMain, 142,   TutorialCallback::kNone,                  TutorialCallback::kEvent26Code272,    TutorialCallback::kMatchType26OrJump,      1,  8520, 10, 0, 22583, 7680 },
...
const TutorialNodeSpec kMainIntro =
  {  0, "RTNI", 4, 7356, "TUTORIAL_MAIN_INTRO", 0,   nullptr,             0,    nullptr,           0,    nullptr,          -1,         142,   TutorialCallback::kNone,    TutorialCallback::kNone,                TutorialCallback::kNone,        0,    0,    11,  0,      0,    0 };

// gilde.exe 0x59b318 — InitMainOutro single node (mask = -9).
const TutorialNodeSpec kMainOutro =
  {  7, "RTUO", 5, 7359, "TUTORIAL_MAIN_OUTRO", 0,   nullptr,             0,    nullptr,           0,    nullptr,          -1,         0,     TutorialCallback::kNone,    TutorialCallback::kNone,                TutorialCallback::kNone,        0,    0,    11,  0,     -9,    0 };
...
TutorialChapterNode* TutorialBuildChain(const TutorialNodeSpec* specs, int count,
    ...
    for (int i = 0; i < count; ++i) {
        ...
        n.name[4]      = static_cast<char>(s.nameByte8);  // +8 (idx2 low byte: builders set v[8]=N)
